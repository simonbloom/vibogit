...
const downloads = [
  {
    ...
    href: "https://github.com/simonbloom/vibogit/releases/latest/download/ViboGit_3.3.0_aarch64.dmg",
  },
  {
    name: "Download for Intel Mac",
    description: "macOS 12+ (x64)",
    href: "https://github.com/simonbloom/vibogit/releases/latest/download/ViboGit_3.3.0_x64.dmg",
  },
];
