...
const downloads = [
  {
    ...
    href: "https://github.com/simonbloom/vibogit/releases/latest/download/ViboGit_3.8.3_aarch64.dmg",
  },
  {
    name: "Download for Intel Mac",
    description: "macOS 12+ (x64)",
    href: "https://github.com/simonbloom/vibogit/releases/latest/download/ViboGit_3.8.3_x64.dmg",
  },
];
